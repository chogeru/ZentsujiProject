...
Shader "DLNK Shaders/ASE/SciFi/HologramSimple"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord8 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				#ifdef _DISPLACECONTINUOUS_ON
				float staticSwitch80 = _TimeParameters.x;
				#else
				float staticSwitch80 = cos( _TimeParameters.x * 0.5 );
				#endif
				float2 temp_cast_0 = (_PannerSpeed).xx;
				float2 temp_cast_1 = (texCoord8.y).xx;
				float2 panner9 = ( staticSwitch80 * temp_cast_0 + temp_cast_1);
				float2 appendResult14 = (float2(texCoord8.x , panner9.x));
				float2 temp_cast_3 = (_PannerSpeed).xx;
				float2 temp_cast_4 = (texCoord8.x).xx;
				float2 panner83 = ( staticSwitch80 * temp_cast_3 + temp_cast_4);
				float2 appendResult88 = (float2(panner83.x , texCoord8.y));
				...
				float cos10_g15 = cos( radians( _GlitchXSpeedYThickZRotW.w ) );
				float sin10_g15 = sin( radians( _GlitchXSpeedYThickZRotW.w ) );
				float2 rotator10_g15 = mul( IN.ase_texcoord8.xy - float2( 0.5,0.5 ) , float2x2( cos10_g15 , -sin10_g15 , sin10_g15 , cos10_g15 )) + float2( 0.5,0.5 );
				float2 appendResult8_g15 = (float2(_GlitchXSpeedYThickZRotW.x , 1.0));
				float mulTime66 = _TimeParameters.x * _GlitchXSpeedYThickZRotW.y;
				float2 appendResult9_g15 = (float2(mulTime66 , 0.0));
				float2 appendResult10_g16 = (float2(_GlitchXSpeedYThickZRotW.z , 1.0));
				float2 temp_output_11_0_g16 = ( abs( (frac( (rotator10_g15*appendResult8_g15 + appendResult9_g15) )*2.0 + -1.0) ) - appendResult10_g16 );
				float2 break16_g16 = ( 1.0 - ( temp_output_11_0_g16 / fwidth( temp_output_11_0_g16 ) ) );
				float smoothstepResult71 = smoothstep( _GlitchSmoothXY.x , _GlitchSmoothXY.y , saturate( min( break16_g16.x , break16_g16.y ) ));
				...
				float3 BaseColor = tex2DNode1.rgb;
				...
				float Occlusion = 1;
				float Alpha = ( tex2DNode1.a * saturate( min( break16_g14.x , break16_g14.y ) ) * _Opacity );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord8 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				#ifdef _DISPLACECONTINUOUS_ON
				float staticSwitch80 = _TimeParameters.x;
				#else
				float staticSwitch80 = cos( _TimeParameters.x * 0.5 );
				...
				float cos10_g15 = cos( radians( _GlitchXSpeedYThickZRotW.w ) );
				float sin10_g15 = sin( radians( _GlitchXSpeedYThickZRotW.w ) );
				float2 rotator10_g15 = mul( IN.ase_texcoord4.xy - float2( 0.5,0.5 ) , float2x2( cos10_g15 , -sin10_g15 , sin10_g15 , cos10_g15 )) + float2( 0.5,0.5 );
				float2 appendResult8_g15 = (float2(_GlitchXSpeedYThickZRotW.x , 1.0));
				float mulTime66 = _TimeParameters.x * _GlitchXSpeedYThickZRotW.y;
				float2 appendResult9_g15 = (float2(mulTime66 , 0.0));
				float2 appendResult10_g16 = (float2(_GlitchXSpeedYThickZRotW.z , 1.0));
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord8 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				#ifdef _DISPLACECONTINUOUS_ON
				float staticSwitch80 = _TimeParameters.x;
				#else
				float staticSwitch80 = cos( _TimeParameters.x * 0.5 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( tex2DNode1.a * saturate( min( break16_g14.x , break16_g14.y ) ) * _Opacity );
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-1604.995,288.4049;Inherit;False;Property;_PannerSpeed;Panner Speed;5;0;Create;True;0;0;0;False;0;False;0.1;0.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;80;-1523.397,393.4456;Inherit;False;Property;_DisplaceContinuous;Displace Continuous;13;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;19;-779.4229,-372.42;Inherit;False;Property;_StripesXSpeedYThickZRotW;StripesX SpeedY ThickZ RotW;6;0;Create;True;0;0;0;False;0;False;100,-10,0.5,90;50,2,0.3,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-193.198,122.0317;Inherit;False;Property;_Opacity;Opacity;1;0;Create;True;0;0;0;False;0;False;1;0.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1;-627.9148,-67.41421;Inherit;True;Property;_MainTex;Albedo;0;0;Create;False;0;0;0;False;0;False;-1;None;bca358fad60f4c141ba5a76ca191dc3d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;65;-1179.181,602.3859;Inherit;False;Property;_GlitchXSpeedYThickZRotW;GlitchX SpeedY ThickZ RotW;8;0;Create;True;0;0;0;False;0;False;2,1,0.1,90;2,0.5,0.4,90;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;66;-862.9035,705.5998;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;64;-820.3151,535.8188;Inherit;False;Stripes;-1;;15;8e73a71cdf24db740864b4c3f3357e7f;0;4;5;FLOAT;6;False;4;FLOAT;0;False;3;FLOAT;0.5;False;12;FLOAT;45;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;72;-574.8235,708.2194;Inherit;False;Property;_GlitchSmoothXY;Glitch Smooth (XY);7;0;Create;True;0;0;0;False;0;False;0,1;0,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ColorNode;75;-226.698,672.6328;Inherit;False;Property;_GlitchColor;GlitchColor;10;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.9339623,0.2571306,0.110137,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;76;-245.4138,601.5625;Inherit;False;Property;_GlitchIntensity;Glitch Intensity;12;0;Create;True;0;0;0;False;0;False;2;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;18;-468.1229,214.08;Inherit;False;Property;_EmissiveColor;Emissive Color;2;0;Create;True;0;0;0;False;0;False;0.5943396,0.5943396,0.5943396,0;0.9528301,0.06741717,0.06741717,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;3;3;112;0
WireConnection;20;0;1;4
WireConnection;20;1;15;0
WireConnection;20;2;38;0
WireConnection;103;0;1;0
WireConnection;103;2;3;0
WireConnection;103;3;91;0
WireConnection;103;4;91;0
WireConnection;103;6;20;0
ASEEND*/
//CHKSM=D321CB8644F37045F8459990D400553DB9D932AA