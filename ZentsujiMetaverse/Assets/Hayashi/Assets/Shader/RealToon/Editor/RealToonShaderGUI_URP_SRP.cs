            ...
            if (ShowUI == true)
            {
                ...
                if (_TRANSMODE.floatValue == 1)
                {
                    ...
                    if (ShowTransparency)
                    {
                        ...
                        GUILayout.Space(10);
                        materialEditor.ShaderProperty(_SimTrans, new GUIContent(_SimTrans.displayName, TOTIPS[149]));
                ...
                if (_N_F_NFD.floatValue == 1)
                {
                    ...
                    if (NearFadeDithering)
                    {
                        ...
                        materialEditor.ShaderProperty(_MinFadDistance, new GUIContent(_MinFadDistance.displayName, TOTIPS[151]));
                        materialEditor.ShaderProperty(_MaxFadDistance, new GUIContent(_MaxFadDistance.displayName, TOTIPS[152]));
...
#if ENABLE_HYBRID_RENDERER_V2
                materialEditor.ShaderProperty(_N_F_DDMD, new GUIContent(_N_F_DDMD.displayName, TOTIPS[150]));
#endif
