...
Shader "WeatherMaker/WeatherMakerWaterTesselationShader"
{
	Properties
	{
		...
		_WaterWave1_Params1("Speed, height reducer, height variance, 0", Vector) = (1, 1, 0, 0)
		_WaterWave2("2: Dir xz, amp, len", Vector) = (0, 0, 0, 0)
		_WaterWave2_Params1("Speed, height reducer, height variance, 0", Vector) = (1, 1, 0, 0)
		_WaterWave3("3: Dir xz, amp, len", Vector) = (0, 0, 0, 0)
		_WaterWave3_Params1("Speed, height reducer, height variance, 0", Vector) = (1, 1, 0, 0)
		_WaterWave4("4: Dir xz, amp, len", Vector) = (0, 0, 0, 0)
		_WaterWave4_Params1("Speed, height reducer, height variance, 0", Vector) = (1, 1, 0, 0)
		_WaterWave5("5: Dir xz, amp, len", Vector) = (0, 0, 0, 0)
		_WaterWave5_Params1("Speed, height reducer, height variance, 0", Vector) = (1, 1, 0, 0)
		_WaterWave6("6: Dir xz, amp, len", Vector) = (0, 0, 0, 0)
		_WaterWave6_Params1("Speed, height reducer, height variance, 0", Vector) = (1, 1, 0, 0)
		_WaterWave7("7: Dir xz, amp, len", Vector) = (0, 0, 0, 0)
		_WaterWave7_Params1("Speed, height reducer, height variance, 0", Vector) = (1, 1, 0, 0)
		_WaterWave8("8: Dir xz, amp, len", Vector) = (0, 0, 0, 0)
		_WaterWave8_Params1("Speed, height reducer, height variance, 0", Vector) = (1, 1, 0, 0)
		...
		_TesselationParams("Factor, Max Displace, 0, 0", Vector) = (16, 20.0, 0.0, 0.0)
	...
	/* /* 	GrabPass { "_CameraOpaqueTexture" } */ */
		...
		Pass
		{
			...
			#pragma hull TesselationHullProgram
			#pragma domain TesselationDomainProgram
			...
			#include "WeatherMakerTesselationShaderInclude.cginc"
