...
public class VivoxCoreInstance {
  ...
  public static string vx_get_self_presence_state_string(vx_presence_state t) {
    string ret = VivoxCoreInstancePINVOKE.vx_get_self_presence_state_string((int)t);
    return ret;
  }
  ...
  public static string vx_get_channel_rolloff_curve_type_string(vx_channel_rolloff_curve_type t) {
    string ret = VivoxCoreInstancePINVOKE.vx_get_channel_rolloff_curve_type_string((int)t);
    return ret;
  }
  ...
  public static string vx_get_connection_state_string(vx_connection_state t) {
    string ret = VivoxCoreInstancePINVOKE.vx_get_connection_state_string((int)t);
    return ret;
  }
  ...
  public static int vx_req_session_set_local_render_volume_create(SWIGTYPE_p_p_vx_req_session_set_local_render_volume req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_session_set_local_render_volume_create(SWIGTYPE_p_p_vx_req_session_set_local_render_volume.getCPtr(req));
    return ret;
  }
  ...
  public static int vx_req_session_delete_message_create(SWIGTYPE_p_p_vx_req_session_delete_message req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_session_delete_message_create(SWIGTYPE_p_p_vx_req_session_delete_message.getCPtr(req));
    return ret;
  }

  public static int vx_req_session_edit_message_create(SWIGTYPE_p_p_vx_req_session_edit_message req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_session_edit_message_create(SWIGTYPE_p_p_vx_req_session_edit_message.getCPtr(req));
    return ret;
  }
  ...
  public static int vx_req_session_chat_history_query_create(SWIGTYPE_p_p_vx_req_session_chat_history_query req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_session_chat_history_query_create(SWIGTYPE_p_p_vx_req_session_chat_history_query.getCPtr(req));
    return ret;
  }

  public static int vx_req_account_chat_history_get_last_read_create(SWIGTYPE_p_p_vx_req_account_chat_history_get_last_read req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_account_chat_history_get_last_read_create(SWIGTYPE_p_p_vx_req_account_chat_history_get_last_read.getCPtr(req));
    return ret;
  }
  ...
  public static int vx_req_aux_get_derumbler_properties_create(SWIGTYPE_p_p_vx_req_aux_get_derumbler_properties req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_aux_get_derumbler_properties_create(SWIGTYPE_p_p_vx_req_aux_get_derumbler_properties.getCPtr(req));
    return ret;
  }

  public static int vx_req_aux_set_derumbler_properties_create(SWIGTYPE_p_p_vx_req_aux_set_derumbler_properties req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_aux_set_derumbler_properties_create(SWIGTYPE_p_p_vx_req_aux_set_derumbler_properties.getCPtr(req));
    return ret;
  }
  ...
  public static int vx_req_account_delete_message_create(SWIGTYPE_p_p_vx_req_account_delete_message req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_account_delete_message_create(SWIGTYPE_p_p_vx_req_account_delete_message.getCPtr(req));
    return ret;
  }

  public static int vx_req_account_edit_message_create(SWIGTYPE_p_p_vx_req_account_edit_message req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_account_edit_message_create(SWIGTYPE_p_p_vx_req_account_edit_message.getCPtr(req));
    return ret;
  }
  ...
  public static int vx_req_account_chat_history_query_create(SWIGTYPE_p_p_vx_req_account_chat_history_query req) {
    int ret = VivoxCoreInstancePINVOKE.vx_req_account_chat_history_query_create(SWIGTYPE_p_p_vx_req_account_chat_history_query.getCPtr(req));
    return ret;
  }
  ...
  public static vx_tts_voice_list_t vx_tts_get_voices(uint tts_manager_id) {
    global::System.IntPtr cPtr = VivoxCoreInstancePINVOKE.vx_tts_get_voices(tts_manager_id);
    vx_tts_voice_list_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new vx_tts_voice_list_t(cPtr, false);
    return ret;
  }

  public static vx_tts_status vx_tts_shutdown() {
    vx_tts_status ret = (vx_tts_status)VivoxCoreInstancePINVOKE.vx_tts_shutdown__SWIG_0();
    return ret;
  }

  public static vx_tts_status vx_tts_shutdown(uint tts_manager_id) {
    vx_tts_status ret = (vx_tts_status)VivoxCoreInstancePINVOKE.vx_tts_shutdown__SWIG_1(tts_manager_id);
    return ret;
  }
  ...
  public static int vx_issue_request3(vx_req_base_t request, out int request_count) {
    int ret = VivoxCoreInstancePINVOKE.vx_issue_request3(vx_req_base_t.getCPtr(request), out request_count);
    return ret;
  }
  ...
  public static int vx_event_to_xml(SWIGTYPE_p_void event_, SWIGTYPE_p_p_char xml) {
    int ret = VivoxCoreInstancePINVOKE.vx_event_to_xml(SWIGTYPE_p_void.getCPtr(event_), SWIGTYPE_p_p_char.getCPtr(xml));
    return ret;
  }

  public static vx_event_type vx_xml_to_event(string xml, SWIGTYPE_p_p_void event_, SWIGTYPE_p_p_char error) {
    vx_event_type ret = (vx_event_type)VivoxCoreInstancePINVOKE.vx_xml_to_event(xml, SWIGTYPE_p_p_void.getCPtr(event_), SWIGTYPE_p_p_char.getCPtr(error));
    return ret;
  }
  ...
  public static int vx_apply_font_to_file_return_energy_ratio(string fontDefinition, string inputFile, string outputFile, out double energyRatio) {
    int ret = VivoxCoreInstancePINVOKE.vx_apply_font_to_file_return_energy_ratio(fontDefinition, inputFile, outputFile, out energyRatio);
    return ret;
  }

  public static int vx_apply_font_to_vxz_file_return_energy_ratio(string fontDefinition, string inputFile, string outputFile, out double energyRatio) {
    int ret = VivoxCoreInstancePINVOKE.vx_apply_font_to_vxz_file_return_energy_ratio(fontDefinition, inputFile, outputFile, out energyRatio);
    return ret;
  }
  ...
  public static int vx_export_audioBuffer_to_memory(SWIGTYPE_p_void audioBufferPtr, SWIGTYPE_p_p_short audioBufferOut, out int nSamplesOut, out int sampleRateOut, out int nChannelsOut) {
    int ret = VivoxCoreInstancePINVOKE.vx_export_audioBuffer_to_memory(SWIGTYPE_p_void.getCPtr(audioBufferPtr), SWIGTYPE_p_p_short.getCPtr(audioBufferOut), out nSamplesOut, out sampleRateOut, out nChannelsOut);
    return ret;
  }
  ...
  public static int vx_get_int_var(string var_name, out int p_value) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_int_var(var_name, out p_value);
    return ret;
  }
  ...
  public static uint vx_get_http(string url, out uint response_code, SWIGTYPE_p_p_char content, SWIGTYPE_p_size_t content_len, SWIGTYPE_p_p_char content_type, SWIGTYPE_p_size_t content_type_len) {
    uint ret = VivoxCoreInstancePINVOKE.vx_get_http(url, out response_code, SWIGTYPE_p_p_char.getCPtr(content), SWIGTYPE_p_size_t.getCPtr(content_len), SWIGTYPE_p_p_char.getCPtr(content_type), SWIGTYPE_p_size_t.getCPtr(content_type_len));
    return ret;
  }
  ...
  public static string vx_get_user_uri(string name, string realm, string issuer) {
    string ret = VivoxCoreInstancePINVOKE.vx_get_user_uri(name, realm, issuer);
    return ret;
  }

  public static string vx_get_echo_channel_uri(string name, string realm, string issuer) {
    string ret = VivoxCoreInstancePINVOKE.vx_get_echo_channel_uri(name, realm, issuer);
    return ret;
  }

  public static string vx_get_general_channel_uri(string name, string realm, string issuer) {
    string ret = VivoxCoreInstancePINVOKE.vx_get_general_channel_uri(name, realm, issuer);
    return ret;
  }

  public static string vx_get_positional_channel_uri(string name, string realm, int max_range, int clamping_distance, double rolloff, vx_channel_rolloff_curve_type distance_model, string issuer) {
    string ret = VivoxCoreInstancePINVOKE.vx_get_positional_channel_uri(name, realm, max_range, clamping_distance, rolloff, (int)distance_model, issuer);
    return ret;
  }

  public static string vx_uri_to_string(int is_multitenant, string uri) {
    string ret = VivoxCoreInstancePINVOKE.vx_uri_to_string(is_multitenant, uri);
    return ret;
  }
  ...
  public static int vx_opus_get_bit_rate(out int p_bits_per_second) {
    int ret = VivoxCoreInstancePINVOKE.vx_opus_get_bit_rate(out p_bits_per_second);
    return ret;
  }
  ...
  public static int vx_opus_get_complexity(out int p_complexity) {
    int ret = VivoxCoreInstancePINVOKE.vx_opus_get_complexity(out p_complexity);
    return ret;
  }
  ...
  public static int vx_opus_get_vbr_mode(out int p_vbr_mode) {
    int ret = VivoxCoreInstancePINVOKE.vx_opus_get_vbr_mode(out p_vbr_mode);
    return ret;
  }
  ...
  public static int vx_opus_get_bandwidth(out int p_bandwidth) {
    int ret = VivoxCoreInstancePINVOKE.vx_opus_get_bandwidth(out p_bandwidth);
    return ret;
  }
  ...
  public static int vx_get_dump_memory_interval() {
    int ret = VivoxCoreInstancePINVOKE.vx_get_dump_memory_interval();
    return ret;
  }

  public static int vx_cpumonitor_start(int interval, int report_interval) {
    int ret = VivoxCoreInstancePINVOKE.vx_cpumonitor_start(interval, report_interval);
    return ret;
  }

  public static int vx_cpumonitor_stop() {
    int ret = VivoxCoreInstancePINVOKE.vx_cpumonitor_stop();
    return ret;
  }

  public static int vx_cpumonitor_start_eater(int nthreads, int priority) {
    int ret = VivoxCoreInstancePINVOKE.vx_cpumonitor_start_eater(nthreads, priority);
    return ret;
  }

  public static int vx_cpumonitor_stop_eater() {
    int ret = VivoxCoreInstancePINVOKE.vx_cpumonitor_stop_eater();
    return ret;
  }
  ...
  public static int vx_android_set_mic_mute(int mute) {
    int ret = VivoxCoreInstancePINVOKE.vx_android_set_mic_mute(mute);
    return ret;
  }
  ...
  public static int vx_get_dynamic_voice_processing_switching_enabled(out int enabled) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_dynamic_voice_processing_switching_enabled(out enabled);
    return ret;
  }
  ...
  public static int vx_get_platform_aec_enabled(out int enabled) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_platform_aec_enabled(out enabled);
    return ret;
  }
  ...
  public static int vx_get_vivox_aec_enabled(out int enabled) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_vivox_aec_enabled(out enabled);
    return ret;
  }
  ...
  public static int vx_get_agc_enabled(out int enabled) {
    int ret = VivoxCoreInstancePINVOKE.vx_get_agc_enabled(out enabled);
    return ret;
  }

  public static vx_tts_status vx_tts_initialize(vx_tts_engine_type engine_type, out uint tts_manager_id) {
    vx_tts_status ret = (vx_tts_status)VivoxCoreInstancePINVOKE.vx_tts_initialize((int)engine_type, out tts_manager_id);
    return ret;
  }
  ...
  public static vx_tts_status vx_tts_speak(uint tts_manager_id, uint voice_id, string input_text, vx_tts_destination tts_dest, out uint utterance_id) {
    vx_tts_status ret = (vx_tts_status)VivoxCoreInstancePINVOKE.vx_tts_speak(tts_manager_id, voice_id, input_text, (int)tts_dest, out utterance_id);
    return ret;
  }
  ...
  public static readonly int VxErrorMessageTextTooLong = VivoxCoreInstancePINVOKE.VxErrorMessageTextTooLong_get();
  public static readonly int VxErrorNoMicrophonePermission = VivoxCoreInstancePINVOKE.VxErrorNoMicrophonePermission_get();
  public static readonly int VxErrorMessageTextRateExceeded = VivoxCoreInstancePINVOKE.VxErrorMessageTextRateExceeded_get();
  public static readonly int VxErrorSessionDoesNotHaveAudio = VivoxCoreInstancePINVOKE.VxErrorSessionDoesNotHaveAudio_get();
  ...
  public static readonly int VxErrorTitleDisabled = VivoxCoreInstancePINVOKE.VxErrorTitleDisabled_get();
  public static readonly int VxXmppErrorBadRequest = VivoxCoreInstancePINVOKE.VxXmppErrorBadRequest_get();
  public static readonly int VxXmppErrorNotAuthorized = VivoxCoreInstancePINVOKE.VxXmppErrorNotAuthorized_get();
  public static readonly int VxXmppErrorItemNotFound = VivoxCoreInstancePINVOKE.VxXmppErrorItemNotFound_get();
  public static readonly int VxXmppErrorNotAllowed = VivoxCoreInstancePINVOKE.VxXmppErrorNotAllowed_get();
  public static readonly int VxXmppInternalServerError = VivoxCoreInstancePINVOKE.VxXmppInternalServerError_get();
  public static readonly int VxXmppErrorFeatureNotImplemented = VivoxCoreInstancePINVOKE.VxXmppErrorFeatureNotImplemented_get();
  ...
  public static readonly int VxNetworkSocketErrorUnknown = VivoxCoreInstancePINVOKE.VxNetworkSocketErrorUnknown_get();
  ...
  public static readonly int VxNetworkReconnectFailure = VivoxCoreInstancePINVOKE.VxNetworkReconnectFailure_get();
